...
// Similar to ESPConnect but without connecting to server
uint8_t ESPAPConnect(struct ESPController* Controller);

// Similar to ESPConnect but without connecting to AP
uint8_t ESPServerConnect(struct ESPController* Controller);
